        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media-body">
                                                    <a href="{{ route('admin.settings.index') }}">Social Media</a>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link bell-link" href="{{ route('admin.contact-us.index') }}">
                    ...
                    <li class="nav-item align-items-center header-border">
                        <a class="btn btn-primary btn-sm" href="{{ route('admin.logout') }}"
                            onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
                        <form id="logout-form" action="{{ \LaravelLocalization::localizeURL('admin/logout') }}"
                            ...
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <div class="header-media">
                                        @if (!empty(Auth::guard('admin')->user()->getFirstMediaUrl('admin')))
                                        <img src="{{ asset(Auth::guard('admin')->user()->getFirstMediaUrl('admin') )}}"
                                            alt="">
                                        @else
                                        <img src="{{ asset('admin/images/noimage.jpg') }}" alt="">
                                        @endif
                                    </div>
                                    <div class="header-info">
                                        <h6>{{ucfirst(Auth::guard('admin')->user()->name)}}</h6>
                                        <p>{{ucfirst(Auth::guard('admin')->user()->email)}}</p>
                                    </div>
                                    @endif
                                </div>
                            </a>
                                ...
                                <div class="card border-0 mb-0">
                                    <div class="card-header py-2">
                                        ...
                                        <div class="products">
                                            ...
                                            @else
                                            <img src="{{ asset('admin/images/noimage.jpg') }}" class="avatar avatar-md"
                                                alt="">
                                            @endif
                                            <div>
                                                <h6>{{ucfirst(Auth::guard('admin')->user()->name)}}</h6>
                                    ...
                                    <div class="card-footer px-0 py-2">
                                        <a class="dropdown-item ai-icon" href="{{ route('admin.logout') }}"
                                        ...
                                        <form id="logout-form-admin"
                                            action="{{ \LaravelLocalization::localizeURL('admin/logout') }}"
                                            method="POST" style="display: none;"> @csrf </form>
                                    </div>
