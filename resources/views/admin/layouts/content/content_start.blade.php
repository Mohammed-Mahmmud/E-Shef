        <div class="content-body">
            ...
            <div class="page-titles">
                ...
                {{-- <a class="text-primary fs-13" data-bs-toggle="offcanvas" href="#offcanvasExample1"
                    role="button" aria-controls="offcanvasExample1">+ Add Task</a> --}}
            </div>
                                    ...
                                    <ul class="nav nav-pills mb-3 earning-tab earning-chart" id="pills-tab1"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-month-tab1" data-series="month"
                                                data-bs-toggle="pill" data-bs-target="#pills-month1"
                                    ...
                                    <table id="projects-tbl" class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/images/contacts/pic1.jpg') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/images/contacts/pic2.jpg') }}"
                                                            class="avatar rounded-circle" alt="">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/images/contacts/pic888.jpg') }}"
                                                            class="avatar rounded-circle" alt="">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/images/contacts/pic999.jpg') }}"
                                                            class="avatar rounded-circle" alt="">
                                                        <p class="mb-0 ms-2">Elijah James</p>
                                                    </div>
                                                </td>
                                    ...
                                    <div class="col-xl-4 active-country dz-scroll">
                                        <div class="">
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/india.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/canada.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/russia.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/uk.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/aus.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/usa.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/pak.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/germany.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/uae.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                            ...
                                            <div class="country-list">
                                                <img src="{{ asset('admin/images/country/china.png') }}"
                                                    alt="">
                                                <div class="progress-box mt-0">
                                                    <div class="d-flex justify-content-between">
                                    ...
                                    <table id="product-tbl" class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d1.jpg') }}"
                                                ...
                                                <td>
                                                    <span class="badge badge-danger light border-0">Out of
                                                        Stock</span>
                                                </td>
                                                <td>
                                                    <span>$1200.75</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d2.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d3.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d4.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d5.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d6.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d7.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d8.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d14.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d13.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d9.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d10.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d11.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/d12.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                        ...
                                        <div class="event-media">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="event-data ms-2">
                                                    <h5 class="mb-0"><a href="javascript:void(0)">Development
                                                            planning</a></h5>
                                    ...
                                    <div class="tbl-caption">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-secondary btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#exampleModal1">+ Invite
                                                Employee
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="javascript:void(0)"
                                                        class="text-primary">abc@gmail.com</a></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="products">
                                                        <img src="{{ asset('admin/images/contacts/pic3.jpg') }}"
                                                            class="avatar avatar-md" alt="">
                                                        <div>
                                                            <h6><a href="javascript:void(0)">Ricky Antony</a></h6>
                                                            <span>Web Designer</span>
