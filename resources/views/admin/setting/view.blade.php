                        ...
                        <table id="datatable" class="table table-striped table-bordered p-0 text-center table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{$Setting->key}}</td>
                                    <td>
                                        <x-admin.form.input old="value" :value="$Setting->value" name="value"
                                            type="text" placeholder="value"></x-admin.form.input>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="col-xl-12">
                    <div class="card dz-card" id="accordion-one">
                        <div class="card-header flex-wrap">
                            <h4 class="card-title">{{ ucfirst($RouteEditSocialMedia)??'name' }}</h4>
                        </div>
                                            ...
                                            <table id="example5" class="display table dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr style="background-color: #F0F4F9;">
                                                        <x-admin.table th1="{{ TranslationHelper::translate('Name') }}"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>{{$Setting->key}}</td>
                                                        <td>
                                                            <x-admin.form.input old="value" :value="$Setting->value"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <x-admin.delete-model :id="$item->id" :name="$item->name"
                                        ...
                                        <table id="example5" class="display table dataTable no-footer"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$item->key}}</td>
                                                    <td>
                                                        <x-admin.form.image-view :model="$item" width="100" height="100" name="Logo">
