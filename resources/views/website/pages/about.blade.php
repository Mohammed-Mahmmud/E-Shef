...
@section('frontTitle',ucwords('about'))
@section('frontMeta')
    <x-website.layouts.meta :slug="'about'"></x-website.layouts.meta>
@endsection
@section('frontStyle')
<style>
    .faqDesc {
...
<x-website.layouts.breadcumb :subSlug="'About'" slug="E-SHEF" subSlug2="About" route="{{route('home')}}" />
            ...
            <div class="col-lg-6">
                <div class="about-thumb mb-50 mb-lg-0">
                    <div class="about-img-1">
                        <img src="{{asset('website')}}/assets/img/normal/about_1-1.jpg" alt="img">
                    </div>
                    <div class="about-img-2">
                        <img src="{{asset('website')}}/assets/img/normal/about_1-2.jpg" alt="img">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-content-wrap">
                    <div class="title-area mb-35">
                        ...
                        <div class="faq-area-2" data-bg-src="{{asset('website/assets')}}/img/update/bg/faq2-bg.png">
                            <div class="container">
                                            ...
                                            <div class="accordion-area style4 accordion" id="faqAccordion">
                                                <div class="accordion-card active ">
                                                    <div class="accordion-header" id="collapse-item-1 ">
                                                        <button class="accordion-button faqTitle" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
