...
class SettingController extends Controller
{
    ...
    public function index():View
    {
        ...
        $image = Setting::where('key','LogoWhite')->orWhere('key','LogoBlack')->orWhere('key','HeaderImage')->get();
    ...
    public function edit($id):View
    {
        ...
        if($id == '13' || $id == '14' || $id == '39'){
            return view($data->key != ('LogoWhite' || 'LogoBlack' ||'HeaderImage') ? $this->nameViewCrud.'.crud':$this->nameViewCrud.'.edit-image',$this->ViewModel($data));
        }
