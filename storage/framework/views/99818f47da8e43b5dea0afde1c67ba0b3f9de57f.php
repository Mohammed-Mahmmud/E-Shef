        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <div class="input-group search-area">
                        <span class="input-group-text"><a href="javascript:void(0)">
                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                    ...
                                    <circle cx="8.78605" cy="8.78605" r="8.23951" stroke="white" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M14.5168 14.9447L17.7471 18.1667" stroke="white" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media-body">
                                                    <a href="<?php echo e(route('admin.settings.index')); ?>">Social Media</a>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link bell-link" href="<?php echo e(route('admin.contact-us.index')); ?>">
                    ...
                    <li class="nav-item align-items-center header-border">
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.logout')); ?>"
                            onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
                        <form id="logout-form" action="<?php echo e(\LaravelLocalization::localizeURL('admin/logout')); ?>"
                            ...
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <div class="header-media">
                                        <?php if(!empty(Auth::guard('admin')->user()->getFirstMediaUrl('admin'))): ?>
                                        <img src="<?php echo e(asset(Auth::guard('admin')->user()->getFirstMediaUrl('admin') )); ?>"
                                            alt="">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('admin/images/noimage.jpg')); ?>" alt="">
                                        <?php endif; ?>
                                    </div>
                                    <div class="header-info">
                                        <h6><?php echo e(ucfirst(Auth::guard('admin')->user()->name)); ?></h6>
                                        <p><?php echo e(ucfirst(Auth::guard('admin')->user()->email)); ?></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </a>
                                ...
                                <div class="card border-0 mb-0">
                                    <div class="card-header py-2">
                                        ...
                                        <div class="products">
                                            ...
                                            <?php else: ?>
                                            <img src="<?php echo e(asset('admin/images/noimage.jpg')); ?>" class="avatar avatar-md"
                                                alt="">
                                            <?php endif; ?>
                                            <div>
                                                <h6><?php echo e(ucfirst(Auth::guard('admin')->user()->name)); ?></h6>
                                    ...
                                    <div class="card-body px-0 py-2">
                                        <?php if(Auth::guard('admin')->check()): ?>
                                                <a href="<?php echo e(route('admin.admins.edit',Auth::guard('admin')->user()->id)); ?>"
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.settings.index')); ?>" class="dropdown-item ai-icon ">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="card-footer px-0 py-2">
                                        <a class="dropdown-item ai-icon" href="<?php echo e(route('admin.logout')); ?>"
                                        ...
                                        <form id="logout-form-admin"
                                            action="<?php echo e(\LaravelLocalization::localizeURL('admin/logout')); ?>"
                                            method="POST" style="display: none;"> <?php echo csrf_field(); ?> </form>
                                    </div>
...
</div><?php /**PATH /home/mohamed-khater/Documents/projects/eshef/resources/views/admin/layouts/head/header.blade.php ENDPATH**/ ?>