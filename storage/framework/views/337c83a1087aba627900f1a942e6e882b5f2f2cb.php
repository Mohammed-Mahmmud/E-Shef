<?php $__env->startSection('frontTitle',ucwords('Search')); ?>
...
<?php $component = App\View\Components\Website\Layouts\Meta::resolve(['slug' => 'search'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/eshef/www/resources/views/website/pages/search.blade.php ENDPATH**/ ?>