...
<?php $component = App\View\Components\Website\Layouts\Meta::resolve(['slug' => 'blogs'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/eshef/www/resources/views/website/pages/blogs.blade.php ENDPATH**/ ?>