<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="menu-title"><h4><b>E-SHEF</b></h4></li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin./')); ?>">Dashboard Light</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin.admins.index')); ?>">Admins</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin.blogs.index')); ?>">Blogs</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin.settings.index')); ?>">Social Media</a></li>
                    <li><a href="<?php echo e(route('admin.contact-us.index')); ?>">ContactUS</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <!--<li><a href="<?php echo e(route('admin.cms-pages.index')); ?>">CMS</a></li>-->
                    <li><a href="<?php echo e(route('admin.pages.index')); ?>">Pages</a></li>
                </ul>
            </li>
...
<?php /**PATH /home/mohamed-khater/Documents/projects/eshef/resources/views/admin/layouts/sidebar/sidebar.blade.php ENDPATH**/ ?>